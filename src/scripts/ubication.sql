INSERT INTO `developer-shopping`.country (`id`,  `name`)
VALUES (1,  'Colombia');

INSERT INTO `developer-shopping`.departament (`id`, `idCountry`, `name`)
VALUES
	(5, 1, 'ANTIOQUIA'), 
	(8, 1, 'ATLÁNTICO'),
	(11, 1, 'BOGOTÁ D.C.'),
	...
	(85, 1, 'CASANARE'),
	(86, 1, 'PUTUMAYO'),
	(88, 1, 'ARCHIPIÉLAGO DE SAN ANDRÉS'),
	(91, 1, 'AMAZONAS'),
	(94, 1, 'GUAINÍA'),
	(95, 1, 'GUAVIARE'),
	(97, 1, 'VAUPÉS'),
...
INSERT INTO `developer-shopping`.city (`id`, `name`, `status`, `idDepartament`)
VALUES
	(1,'Abriaquí',1,5),
	(2,'Acacías',1,50),
	(3,'Acandí',1,27),
